...
async function pushK(){var k=document.getElementById('pk').value.trim(),d=parseInt(document.getElementById('pd').value)||30;if(!k){alert('Enter key');return}var r=await ac('/admin/push-key',{keyName:k,days:d});r.success?(alert('✅ '+r.message),location.reload()):alert('❌ '+(r.e||'Error'))}
